...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      url: 'https://github.com/Harold-Odro',
      icon: (
    ...
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/in/harold-odro',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black">
      ...
      <div className="container mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm">
              Crafting digital experiences through innovative solutions and creative development.
            </p>
          </div>
        ...
        >
          <p>© {new Date().getFullYear()} Harold Odro. All rights reserved.</p>
        </motion.div>
      </div>
    </footer>
  );
